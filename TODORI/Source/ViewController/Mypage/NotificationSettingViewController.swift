...
class NotificationViewController: UIViewController{
    private let notificationTurnOnAndOffLabel: UILabel = {
        ...
        label.text = "알림 켜기/끄기"
        label.textColor = UITraitCollection.current.userInterfaceStyle == .light ? UIColor(red: 0.62, green: 0.62, blue: 0.62, alpha: 1) : UIColor(red: 0.447, green: 0.447, blue: 0.447, alpha: 1)
    ...
    private let infoImage: UIImageView = {
        let image: UIImageView = UIImageView(image: UIImage(named: "info")?.resize(to: CGSize(width: 12, height: 12)))
        return image
    }()
    ...
    private let infoLabel: UILabel = {
        let label: UILabel = UILabel()
        label.text = "안내사항"
        label.textColor = UITraitCollection.current.userInterfaceStyle == .light ? UIColor(red: 0.62, green: 0.62, blue: 0.62, alpha: 1) : UIColor(red: 0.867, green: 0.859, blue: 0.859, alpha: 1)
    ...
    private let paddingViewForStackView: UIView = {
        ...
        view.backgroundColor = UITraitCollection.current.userInterfaceStyle == .light ? UIColor(red: 0.93, green: 0.93, blue: 0.93, alpha: 1) : UIColor(red: 0.322, green: 0.322, blue: 0.322, alpha: 1)
    ...
    private let infoListLabel: UILabel = {
        ...
        label.textColor = UITraitCollection.current.userInterfaceStyle == .light ? UIColor(red: 0.76, green: 0.76, blue: 0.76, alpha: 1) : UIColor(red: 0.447, green: 0.447, blue: 0.447, alpha: 1)
